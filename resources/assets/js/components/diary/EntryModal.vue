...
.modal-enter .ui-modal-content,
.modal-leave-to .ui-modal-content {
  transform: scale(0.7);
}
...
.modal-slide-right-enter-to,
.modal-slide-right-leave,
.modal-slide-left-enter-to,
.modal-slide-left-leave {
  opacity: 1;
...
.modal-slide-bottom-enter-to,
.modal-slide-bottom-leave,
.modal-slide-top-enter-to,
.modal-slide-top-leave {
  opacity: 1;
...
.modal-fall-enter-active,
.modal-fall-leave-active {
  perspective: 1000px;
  transition: opacity 0.3s;
